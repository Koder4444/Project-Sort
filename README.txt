...
- Command 2: Run on generated data with specific size and order.
...
Algorithm      | [name]       | selection-sort, insertion-sort, bubble-sort,
               ...
               |              | flash-sort.
Input File     | [path]       | Path to .txt file. Line 1: n elements.
               |              | Line 2: n space-separated integers.
Input Size     | [int]        | Elements to generate (Max: 1,000,000).
...
Output Param   | -time        | Display the execution time.
               | -comp        | Display number of comparisons.
